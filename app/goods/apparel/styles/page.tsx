...
const apparelDetailLinks = [
  {
    title: "Blank",
    href: "#styles-catalog",
    description: "Start with the tee, fleece, polo, or layer that matches the job before decoration starts narrowing the build.",
  ...
  },
  {
    title: "Color",
    href: "#styles-catalog",
    description: "Use the style grid to sort by color family early so the garment direction stays aligned with the brand palette.",
  ...
  },
  {
    ...
    description: "Once the garment is right, move into screen print, embroidery, placements, and finishing details in the builder.",
  ...
  },
  {
    title: "Quantity",
    href: "/build/og-crafted-apparel",
    description: "Then set the size run, dial in the order quantity, and send the build through for review.",
...
export const metadata = {
  title: "Apparel Styles — Orange Goods",
  description:
    "Start with the apparel style first, then build out the color, decoration, and finishing details around the garment.",
};

export default function ApparelStylesPage() {
  ...
  return (
    <main className="bg-[#F7F4ED] pb-24 md:pb-0">
        ...
        <div className="relative mx-auto max-w-6xl">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/82 md:text-xl">
              Pick the apparel style first. Then build out color, decoration, placements, and
              finishing details around the blank that makes the most sense.
            </p>
            <p className="mt-4 text-sm font-semibold uppercase tracking-[0.12em] text-white/78">
              Premium blanks. Better fits. A cleaner path into the builder.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl rounded-[2rem] border border-[#0B32A0]/10 bg-white px-6 py-8 shadow-[0_24px_80px_rgba(8,30,111,0.08)] md:px-8 md:py-10">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-3xl font-semibold leading-tight text-[var(--og-blue)] md:text-5xl">
              Start with the blank, then build out the details.
            </h2>
            <p className="mt-4 text-base leading-7 text-[var(--og-muted)] md:text-lg">
              Once the garment is right, the rest of the decisions get easier: color, decoration,
              quantity, and finishing details.
            </p>
          </div>

          <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {apparelDetailLinks.map((link) => (
              <Link
                key={link.title}
                href={link.href}
      ...
      <CTASection
        eyebrow="Want to browse wider?"
        title="See all goods."
        description="Jump into the broader goods browser if you want to compare apparel against hats, bags, drinkware, and other categories."
        buttonLabel="Browse all goods"
        buttonHref="/goods/all"
        backgroundImage="/images/gallery/apparel-686-hoodie-front.jpg"
