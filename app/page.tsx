...
const homepageGoodsCategories = [
  {
    ...
    mobileVideo: "/videos/homepage/headwear-c3749-mobile-safe-v2.mp4",
...
export default function HomePage() {
  return (
    <main className="pb-24 md:pb-0">
      ...
      {/* Fat Frank divider */}
      <div className="hidden border-b-[3px] border-[#1C1C1C] bg-[#081E6F] px-4 py-4 text-center md:block md:px-6 md:py-5 lg:px-8">
        <p
      ...
      <Reveal yOffset={0} className="relative overflow-hidden bg-white px-4 pb-0 pt-14 md:px-8 md:pb-[20px] md:pt-20 lg:px-12">
        <section className="mx-auto max-w-6xl">
          <div className="relative left-1/2 mb-6 hidden w-screen -translate-x-1/2 items-center justify-center gap-4 md:mb-8 md:flex md:gap-6">
            <div
                ...
                {category.slideshow ? (
                  ...
                  <>
                    <video
                      ...
                      preload="metadata"
                      className={`absolute inset-0 h-full w-full object-cover transition duration-500 lg:hidden ${
                        category.imageClassName || "group-hover:scale-105"
                      }`}
                      style={{ objectPosition: category.imagePosition }}
                    >
                      <source src={category.mobileVideo || category.video} type="video/mp4" />
                    </video>
                    <video
                      aria-hidden="true"
                      autoPlay
                      ...
                      poster={category.poster || category.image}
                      preload="metadata"
                      className={`absolute inset-0 hidden h-full w-full object-cover transition duration-500 lg:block ${
                        category.imageClassName || "group-hover:scale-105"
                      }`}
                      style={{ objectPosition: category.imagePosition }}
                    >
      ...
      <Reveal className="relative isolate overflow-hidden px-4 py-16 md:px-8 md:py-20 lg:px-12">
        ...
        <section id="why-orange-goods" className="relative z-10 mx-auto max-w-6xl scroll-mt-24">
          ...
          >
            ...
            <span className="inline-flex items-center gap-x-3 whitespace-nowrap md:gap-x-4">
              <span>choose</span>
              <Image
