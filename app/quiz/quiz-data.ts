...
export const mainQuizQuestions: Question[] = [
  ...
  },
  {
    ...
    options: ["2-3 weeks", "1-2 Months", "3+ Months", "No rush"],
  },
  {
    id: "budget",
    eyebrow: "3 of 6",
    title: "What's the budget per item?",
  ...
  },
  {
    ...
    options: ["Wear It Every Day", "Drink From It", "Carry It Around", "Not sure yet"],
  },
];
...
export const mainQuizProducts: Product[] = [
  ...
  },
  {
    id: "tumbler",
    name: "Tumbler",
    image: "/images/gallery/drinkware-stanford-tumblers-ai-1020-2026-08-13.jpg",
    alt: "Black branded tumbler standing upright outdoors",
    category: "drinkware",
    position: "center 56%",
  },
  {
    id: "bottle",
    name: "Bottle",
    image: "/images/gallery/drinkware-stanford-bamboo-bottles-2026-08-13.jpg",
    alt: "Two branded bamboo water bottles on a table",
    category: "drinkware",
    position: "center 48%",
  },
  {
...
export function getMainQuizWhyText(product: Product, answers: MainQuizAnswers) {
  ...
  if (product.id === "bottle" && (use === "Drink From It" || use === "Carry It Around")) {
    return "A branded bottle moves through commutes, workouts, and day bags, so it stays visible well beyond the original handoff";
  }
  ...
  if (product.id === "patchKit" && use === "Not sure yet") {
