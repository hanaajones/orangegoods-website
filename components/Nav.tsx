    ...
    <>
      <header className="sticky top-0 z-40">
        ...
        >
          ...
          {activeMenu ? (
            <div
              className="absolute left-6 right-6 top-[calc(100%+0.75rem)] hidden min-h-[320px] rounded-[2rem] border-[3px] border-[#0B32A0] bg-[#F3EFE7] p-5 text-[#1C1C1C] shadow-[0_28px_60px_rgba(0,0,0,0.12)] md:block"
