        ...
        <div className="mx-auto max-w-6xl px-4 py-12 md:px-8 md:py-16 lg:px-12">
          ...
          <div className="mt-10 flex flex-col items-start gap-4 border-t border-white/10 pt-8 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                href="/quiz"
                className="font-body inline-flex items-center rounded-xl border-2 border-white bg-transparent px-6 py-3 text-sm font-semibold uppercase tracking-[0.08em] text-white transition hover:-translate-y-[3px]"
              >
                Merch Quiz
              </a>
            </div>
